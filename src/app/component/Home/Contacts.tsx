                    ...
                    <div className='col-span-10 sm:col-span-3'>
                        <div className='mb-11 text-center'>
                            ...
                            <h1 className="mb-5 text-Dark text-2xl sm:text-3xl leading-8 sm:leading-10 font-medium">
                                Get in Touch With <span className='font-bold uppercase'> Our Team </span>
                            </h1>
                        </div>
                        ...
                        <form className=''>
                            ...
                            <div className='w-full text-center'>
                                <input type="button" value="Submit" className='mx-auto px-8 py-2 rounded-full bg-primaryColor hover:bg-transparent border-2 border-transparent hover:border-primaryColor text-Light hover:text-primaryColor font-semibold text-lg duration-300' />
                            </div>
                        </form>
                    </div>
                </div>
