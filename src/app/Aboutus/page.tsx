...
export default function About() {
  ...
  <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
    <div className="md:w-2/3">
      <p className="text-gray-700 text-lg leading-relaxed mb-4">
        Narsingh Dass Group is a multifarious trading group, renowned and much admired in the paper industry. With its core business aimed to create an efficient flow of goods between manufacturers and consumers of 
        <span className="font-bold"> paper, paperboard & related products,</span> the group has risen consistently to be one of the most trusted business houses of its kind in India.
      </p>
      <p className="text-gray-700 text-lg leading-relaxed mb-4">
        With a corporate philosophy based on Knowledge Partnership, Narsingh Dass Group follows a guiding principle of <span className="font-bold">Customers Grow, We Grow</span>. With this belief, the group has enjoyed consistent growth and expansion over the years and has transformed itself from a Trading company to a complete <span className="font-bold"> Solution Marketing Group </span>
      </p>
      <p className="text-gray-700 text-lg leading-relaxed mb-4">
        Our Business centers are - Narsingh Dass & Co., Narsingh Dass (Co. Pvt. Ltd.), India Paper Products / Sudhir Papers / Synchem, Shivananda Marketing Pvt. Ltd., Sudhir Papers Limited.
      </p>
    </div>
  ...
  <div className="container mx-auto px-6 mt-6">
    <p className="text-gray-700 text-lg leading-relaxed mb-4">
      <span className="font-bold"> Shivananda Marketing Pvt. Ltd. </span> was established in 1989 and has since been a pioneer in implementing new technologies and adopting advanced materials in emerging and growing sectors. With nearly three and a half decades of experience, we have become one of the leading names in fiber reinforcement technology and building materials in the Indian infrastructure ecosystem. We bring innovative product solutions, new formulations, on-site technical support and end-to-end solutions for the construction industry. Our business operates in almost all the Indian states while reaching out to global clients in most of the nations in the Indian subcontinent, SEA and the Middle East. In the future, we aim to reach out to more countries in the European and American markets.
    </p>
    <p className="text-gray-700 text-lg leading-relaxed mb-4">
      Our specialized and modern warehouse facilities are equipped with adequate staff to ensure that our clients are able to meet their timelines. To meet the industrial standards, we perform extensive quality testing and quality assurance on all our products. Our objective is to remain responsive to the needs of our customers and providing the product or service they require. Flexibility and creativity are the basis of our success. Our pioneering spirit enables us to explore, develop, and drive innovations that make a positive difference in people’s lives. 
    </p>
  </div>
</section>
